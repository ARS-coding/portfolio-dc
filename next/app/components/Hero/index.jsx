...
export function Hero() {
  useEffect(() => {
    if (window.innerWidth >= 992) {
      gsap.from(".hero-content-container", { duration: 1, opacity: 0.3, y: -20 });
      ...
      <Container className="hero-content-container ms-lg-0 px-0 d-flex justify-content-center align-items-center">
        <div className="text-center">
          <h1 className="mx-auto">
            <span className="beautifully">Beautifully</span> Crafted
            <br />
            Web Experiences
          </h1>
          <div className="meet mx-auto">
            ...
            <p className="meet-text">
              <span>Meet</span> Ali Rıza Şahin
            </p>
          </div>
          <ScrollIconSVG className="scroll-svg mx-auto" />
        </div>

        <Image src="hero-shapes.svg"></Image>
